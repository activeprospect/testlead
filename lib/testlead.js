...
const openInBrowser = function (postingUrl, postResponse, browser) {
...
submitLead(program).then((body) => {
  if (body && program.open && program.browser) {
